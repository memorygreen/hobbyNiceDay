...
<body>
	...
	<div class="hero__slider owl-carousel">
		<div class="hero__items set-bg" data-setbg="<c:url value='/images/img/hero/hero-1.jpg' />">
			<div class="container">
				<div class="row">
		...
		<div class="hero__items set-bg" data-setbg="<c:url value='/images/img/hero/hero-2.jpg' />">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-7 col-md-8">
						<div class="hero__text">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="categories__hot__deal">
					<img src="<c:url value='/images/img/product-sale.png' />"  alt="">
			...
			<div class="col-lg-8">
				<div class="instagram__pic">
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-1.jpg' />"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-2.jpg' />"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-3.jpg' />"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-4.jpg' />"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-5.jpg' />"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="<c:url value='/images/img/instagram/instagram-6.jpg' />"></div>
				</div>
			</div>
			<div class="col-lg-4">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="<c:url value='/images/img/blog/blog-1.jpg' />"></div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="<c:url value='/images/img/blog/blog-2.jpg' />"></div>
					<div class="blog__item__text">
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="<c:url value='/images/img/blog/blog-3.jpg' />"></div>
					<div class="blog__item__text">
